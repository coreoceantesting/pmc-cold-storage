                        ...
                        <div class="body" style="padding:30px;">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pt-5 text-center">
                                    ...
                                    <!--<p class="font-weight-bold">Mobile number -  {{ $meat_registration_pdf->mobile_number }}</p>-->
                                </div>
                                 <div class="col-md-12 col-sm-12 pt-3 text-center">
                                    ...
                                    <h5 class="font-weight-bold"><b>License Number : -  {{ $meat_registration_pdf->cold_storage_aplication_no }}</b> </h5>
                                </div>
                            </div>
