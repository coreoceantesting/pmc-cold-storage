...
<html class="no-js " lang="en">
    ...
    <body class="theme-blush" style='background-image:url("{{ url('/') }}/assets/images/main_bg.jpg"); background-position: center; background-repeat: no-repeat; background-size: cover; height: 100%;'>
                            ...
                            <tbody>
                                ...
                                <?php if($type == 'register'){ ?>
                                      <tr>
                                            ...
                                            if($get_details->hod_status == 0){   ?>
                                            <td>Hod Status  </td>  
                                            <td>Pending</td>
                                            <?php }elseif($get_details->hod_status == 1){ ?>
                                            <td>Hod Status  </td>  
                                            <td>Approve</td>
                                            <?php }else { ?>
                                            <td>Hod Status  </td>  
                                           ...
                                           <?php  if($get_details->hod_status == 0){   ?>

                                             <td>Your Application No :- {{ $get_details->cold_storage_aplication_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is (Pending) not yet proceesed by Head Of Department.</td>

                                            <?php }elseif($get_details->hod_status == 1){ ?>

                                            <td>Your Application No :- {{ $get_details->cold_storage_aplication_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is  proceesed by Head Of Department.</td>

                                            <?php }else { ?>

                                             <td>Your Application No :- {{ $get_details->cold_storage_aplication_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is Rejected by Head Of Department reason due to ({{ $get_details->reason_for_rejection }}).</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Admin Status</td>  
                                            <td>Pending</td>
                                            <?php }elseif($get_details->status == 1){ ?>
                                            <td>Admin Status</td>  
                                            <td>Approve</td>
                                            <?php }else { ?>
                                            <td>Admin Status</td>  
                                           ...
                                           <?php  if($get_details->status == 0){   ?>

                                             <td>Your Application No :- {{ $get_details->cold_storage_aplication_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is (Pending) not yet proceesed by Admin Department.</td>

                                            <?php }elseif($get_details->status == 1){ ?>

                                            <td>Your Application No :- {{ $get_details->cold_storage_aplication_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is  proceesed by Admin Department.</td>

                                            <?php }else { ?>

                                             <td>Your Application No :- {{ $get_details->cold_storage_aplication_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is Rejected by Admin Department reason due to ({{ $get_details->reason_rejection_by_admin }}).</td>
                                        ...
                                        <?php 
                                            ...
                                            if($get_details->final_approve == 0){   ?>
                                            <td>Final Status </td>   
                                            <td>Pending</td>
                                            <?php }elseif($get_details->final_approve == 1){ ?>
                                            <td>Final Status </td>   
                                            <td>Approve</td>
                                            <?php }else { ?>
                                            <td>Final Status </td>   
                                           ...
                                           <?php  if($get_details->final_approve == 0){   ?>

                                             <td>Your Application No :- {{ $get_details->cold_storage_aplication_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is (Pending) not yet proceesed by Pmc Office .</td>

                                            <?php }elseif($get_details->final_approve == 1){ ?>

                                            <td>Your Application No :- {{ $get_details->cold_storage_aplication_no }} For शीतगृहर परवान्यासाठी अर्ज  is approved by PMC Office. Please collect your certificate from PMC office.</td>
                                            <?php }else { ?>

                                             <td>Your Application No :- {{ $get_details->cold_storage_aplication_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is Rejected by PMC Office reason due to ({{ $get_details->final_reason_for_rejection }}).</td>
                                    ...
                                    <tr>
                                            ...
                                            if($get_details->re_hod_status == 0){   ?>
                                            <td>Hod Status  </td>  
                                            <td>Pending</td>
                                            <?php }elseif($get_details->re_hod_status == 1){ ?>
                                            <td>Hod Status  </td>  
                                            <td>Approve</td>
                                            <?php }else { ?>
                                            <td>Hod Status  </td>  
                                           ...
                                           <?php  if($get_details->re_hod_status == 0){   ?>

                                             <td>Your Application No :- {{ $get_details->renwal_liceans_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is (Pending) not yet proceesed by Head Of Department.</td>

                                            <?php }elseif($get_details->re_hod_status == 1){ ?>

                                            <td>Your Application No :- {{ $get_details->renwal_liceans_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is  proceesed by Head Of Department.</td>

                                            <?php }else { ?>

                                             <td>Your Application No :- {{ $get_details->renwal_liceans_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is Rejected by Head Of Department reason due to ({{ $get_details->reason_for_rejection }}).</td>
                                        ...
                                        <tr>
                                           ...
                                           <?php  if($get_details->status == 0){   ?>
                                             ...
                                             <td>Your Application No :- {{ $get_details->renwal_liceans_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is (Pending) not yet proceesed by Admin Department.</td>

                                            <?php }elseif($get_details->status == 1){ ?>

                                            <td>Your Application No :- {{ $get_details->renwal_liceans_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is  proceesed by Admin Department.</td>

                                            <?php }else { ?>

                                             <td>Your Application No :- {{ $get_details->renwal_liceans_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is Rejected by Admin Department reason due to ({{ $get_details->reason_rejection_by_admin }}).</td>
                                        ...
                                        <?php 
                                            ...
                                            if($get_details->re_final_status == 0){   ?>
                                            <td>Final Status </td>   
                                            <td>Pending</td>
                                            <?php }elseif($get_details->re_final_status == 1){ ?>
                                            <td>Final Status </td>   
                                            <td>Approve</td>
                                            <?php }else { ?>
                                            <td>Final Status </td>   
                                           ...
                                           <?php  if($get_details->re_final_status == 0){   ?>

                                             <td>Your Application No :- {{ $get_details->renwal_liceans_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is (Pending) not yet proceesed by Pmc Office .</td>

                                            <?php }elseif($get_details->re_final_status == 1){ ?>

                                            <td>Your Application No :- {{ $get_details->renwal_liceans_no }} For शीतगृहर परवान्यासाठी अर्ज  is approved by PMC Office. Please collect your certificate from PMC office.</td>
                                            <?php }else { ?>

                                             <td>Your Application No :- {{ $get_details->renwal_liceans_no }} <br> For शीतगृहर परवान्यासाठी अर्ज is Rejected by PMC Office reason due to ({{ $get_details->final_reason_for_rejection }}).</td>
                            ...
                            <div class="card shadow text-white bg-primary1 h-100 " style="border:solid 2px black; " >
                                <div class="card-body  mb-0 p-0 d-flex flex-column align-items-center justify-content-between" >        
                                   ...
                                   <div class="d-flex flex-column justify-content-between align-items-center">
                                        ...
                                        <div class="font-size-12 text-white mt-3 mb-0">
                                            @if($isAuthenticated)
                                                @if(!empty($isRenewable->is_expired) == 1)
                                                    <span style="text-align:center;">
