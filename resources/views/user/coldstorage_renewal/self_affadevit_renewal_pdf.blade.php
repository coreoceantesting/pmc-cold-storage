                                     ...
                                     <p class="mb-0">
                                       मी <span></span> <strong>
                                        <?php
                                           ...
                                           {{ $applicant_title_id }} {{ $meat_registration_pdf->applicant_fname }} {{ $meat_registration_pdf->applicant_mname }} {{ $meat_registration_pdf->applicant_lname }}</strong> राहणार <strong> {{ $meat_registration_pdf->house_number }} {{ $meat_registration_pdf->house_name }} {{ $meat_registration_pdf->street_1 }} {{ $meat_registration_pdf->area_1 }},{{  $meat_registration_pdf->taluka_name }} ,  {{ $meat_registration_pdf->dist_name }}  </strong> असे लिहून  देतो / देते  कि, वर नमूद केलेली माहिती सत्य असून सोबत जोडलेला सर्व कागदपत्र योग्य व वैध आहेत. तसेच खालील नियमातील तरतुदीचे व महापालिकेच्या सूचनांचे पालन करणे माझ्यावर बंधनकारक राहतील.</p>
<br>
                                   ...
                                   <p class="mb-0">
                                       I <span></span> <strong>
                                        <?php
                                         ...
                                         {{ $applicant_title_id }} {{ $meat_registration_pdf->applicant_fname }} {{ $meat_registration_pdf->applicant_mname }} {{ $meat_registration_pdf->applicant_lname }}</strong> will stay <strong> {{ $meat_registration_pdf->house_number }} ,{{ $meat_registration_pdf->house_name }}, {{ $meat_registration_pdf->street_1 }} ,{{ $meat_registration_pdf->area_1 }}, {{  $meat_registration_pdf->taluka_name }}, {{ $meat_registration_pdf->dist_name }}  </strong>  that all information furnished above all documents submitted by me is true & valid the best of my knowledge and belief. Also I further state that provisions of following laws and instructions given by Corporation is binding on me.</p>
                             ...
                             <div class="row pt-3"> 
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    <p class="mb-0">
                                        ...
                                        <strong>ठिकाण / Place :     {{  $meat_registration_pdf->taluka_name }}  </strong>
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 text-right">
                                    <p class="mb-0">
                                       <strong>
                                            <img src="{{url('/')}}/PMC_Cold_Storage/meat_file/applicant_signature/{{ $data_registraion->applicant_signature }} " alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:100px;">
                                       </strong> <br>
