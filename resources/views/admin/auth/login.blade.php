    ...
    max-width: 550px;">
                <!--<div class="row">-->
                    ...
                    <!--<div class="col-lg-6 col-sm-6">-->
                        <form class="card auth_form transpert" method="POST" action="{{ url('/admin/login') }}"  enctype="multipart/form">
                            @csrf
                            ...
                            <div class="header">
                                ...
                                <h5 style="color: #e77912;font-weight: 800;">{{ __('Admin Login(लॉगिन करा)') }}</h5>
                            </div>
