                                    ...
                                    <tbody>
                                        ...
                                        @if(!empty($meat_search_registration_list))
                                            ...
                                            ?>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/all_register_pet/view', $value->id ) }}"  class="btn btn-primary waves-effect m-r-20">
                                                            View
                                                        </a>
                                                    </td>
                                                </tr>
                                        ...
                                        @else
                                            @foreach ($meat_registration_list as $key => $value)
                                                ...
                                                ?>
                                                <td style="display:none">{{ $business_type }}</td>
                                                <td>
                                                    @php
                                                        $array = explode(",",$value->meat_type);
