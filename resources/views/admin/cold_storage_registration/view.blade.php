                            ...
                            <div id="div2" style="display: none;">
                                <div class="form-group row">
                                  ...
                                  <label class="col-sm-2"><strong>Upload ID proof (Adharcard) of the applicant  <br> (अर्जदाराचा आयडी पुरावा (आधारकार्ड) अपलोड करा ) : <span style="color:red;">*</span></strong></label>
                                    <div class="col-sm-4 col-md-4 p-2">
                                         @if(!$meat_registration_view || !$meat_registration_view->adharcard_doc)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                       @if(!$meat_registration_view || !$meat_registration_view->residitional_proof_doc)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                        @if(!$meat_registration_view || !$meat_registration_view->legal_business_doc)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                         @if(!$meat_registration_view || !$meat_registration_view->business_registration_doc)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                         @if(!$meat_registration_view || !$meat_registration_view->property_tax_doc)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                        @if(!$meat_registration_view || !$meat_registration_view->paid_water_doc)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                         @if(!$meat_registration_view || !$meat_registration_view->slaughter_letter_doc)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                         @if(!$meat_registration_view || !$meat_registration_view->treatment_authorized_doc)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                    @if(!$meat_registration_view || !$meat_registration_view->fitness_certificate_doc)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
    ...
    <div class="form-group">
        ...
        ?>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                         @if(!$meat_registration_view || !$meat_registration_view->applicant_signature)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                         @if(!$meat_registration_view || !$meat_registration_view->profile_photo)
                                        <p class="mt-3 mb-0">Document Not Uploaded</p>
                                    @else
                                            ...
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    ...
                                                    <!--<button type="button" class="btn btn-success waves-effect m-r-20" data-toggle="modal" data-target="#largeModal">Approve</button>-->
                                                     ...
                                                     <a href='{{ url("/approve_cold_registration/{$meat_registration_view->id}") }}'><button  type="button" class="btn btn-success">Approve </button> </a>
                                                </div>
                                            </div>
