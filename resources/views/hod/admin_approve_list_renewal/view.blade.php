        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                       ...
                       <h2>Approve Cold Storage Renewal  Application tt</h2>
                ...
                <form method="POST" action="{{ url('final_approve_cold_renewal', $meat_renewal_view->id ) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-3 col-md-3 p-2">
                            <input type="file" name="re_hod_sign" id="re_hod_sign" class="form-control @error('re_hod_sign') is-invalid @enderror" value="{{ old('re_hod_sign') }}" accept=".jpg, .jpeg, .png">
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-md-3"></label>
                        <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                            <a href='{{ url("/final_approve_view_renewal/{$meat_renewal_view->id}/{$meat_renewal_view->re_final_approve}") }}' class="btn btn-danger btn-lg">Cancel</a>&nbsp;&nbsp;
