                        ...
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <h2>
                                    ...
                                    <strong style="float: right;">{{ $total_pending_meat_register_hod_status }}</strong>
                                </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <h2>
                                    <img src="https://cdn-icons-png.flaticon.com/128/1134/1134447.png" class="rounded-circle" alt="meat" style="enable-background:new 0 0 512 512 height:50px; width:50px;">                                                                        
                                    <strong style="float: right;">{{ $total_approve_meat_register_hod_status }}</strong>
                                </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <h2>
                                    <img src="https://cdn-icons-png.flaticon.com/128/1134/1134447.png" class="rounded-circle" alt="meat" style="enable-background:new 0 0 512 512 height:50px; width:50px;">                                                                        
                                    <strong style="float: right;">{{ $total_rejected_meat_register_hod_status }}</strong>
                                </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <strong style="font-weight:900px;">Final Total Pending Form</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <strong style="font-weight:900px;">Final Total Approved Form</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <strong style="font-weight:900px;">Final Total Rejected Form</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <h2>
                                    <img src="https://cdn-icons-png.flaticon.com/128/1134/1134447.png" class="rounded-circle" alt="meat" style="enable-background:new 0 0 512 512 height:50px; width:50px;">                                                                        
                                    <strong style="float: right;">{{ $total_pending_cold_renewal_register_re_hod_status }}</strong>
                                </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <h2>
                                    <img src="https://cdn-icons-png.flaticon.com/128/1134/1134447.png" class="rounded-circle" alt="meat" style="enable-background:new 0 0 512 512 height:50px; width:50px;">                                                                        
                                    <strong style="float: right;">{{ $total_approve_cold_renewal_register_re_hod_status }}</strong>
                                </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <h2>
                                    <img src="https://cdn-icons-png.flaticon.com/128/1134/1134447.png" class="rounded-circle" alt="meat" style="enable-background:new 0 0 512 512 height:50px; width:50px;">                                                                        
                                    <strong style="float: right;">{{ $total_rejected_cold_renewal_register_re_hod_status }}</strong>
                                </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <strong style="font-weight:900px;">Final Total Pending Cold Storage Renewal Form</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <strong style="font-weight:900px;">Final Total Approved Cold Storage Renewal Form</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card widget_2 ">
                            <div class="body">
                                ...
                                <strong style="font-weight:900px;">Final Total Rejected Cold Storage Renewal Form</strong>
                            </div>
                        </div>
                    </div>
