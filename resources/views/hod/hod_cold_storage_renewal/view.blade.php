...
<section class="content">
                                ...
                                <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4 p-2">
                                                ...
                                                <input type="text" class="form-control @error('unit') is-invalid @enderror"
                                                       value="{{ $unit_Meat_Type->firstWhere('id', old('unit') ?? $meat_renewal_view->unit)->unit_name ?? '' }}"
                                                       readonly style="width: 100%; height: 38px;" />

                                                <!-- Hidden input to send the unit ID -->
                                                <input type="hidden" name="unit"
                                                       value="{{ old('unit') ?? $meat_renewal_view->unit }}" />
                                ...
                                <div id="div2" style="display: none;">
                                    <div class="form-group row">
                                      ...
                                      <label class="col-sm-2"><strong>Upload ID proof (Adharcard) of the applicant  <br> (अर्जदाराचा आयडी पुरावा (आधारकार्ड) अपलोड करा ) : <span style="color:red;">*</span></strong></label>
                                        <div class="col-sm-4 col-md-4 p-2">
                                            <div class="form-group">
                                                <?php
                                                $document_path = $meat_renewal_view->adharcard_doc;
                                       ...
                                       <div class="col-sm-4 col-md-4 p-2">
                                        <div class="form-group">
                                            <?php
                                            $document_path = $meat_renewal_view->residitional_proof_doc;
                                      ...
                                      <div class="form-group row">
                                       ...
                                       <div class="col-sm-4 col-md-4 p-2">
                                            <div class="form-group">
                                                <?php
                                                $document_path = $meat_renewal_view->business_registration_doc;
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4 p-2">
                                            <div class="form-group">
                                            <?php
                                            $document_path = $meat_renewal_view->property_tax_doc;
                                        ...
                                        <div class="col-sm-4 col-md-4 p-2">
                                            <div class="form-group">
                                                <?php
                                                $document_path = $meat_renewal_view->paid_water_doc;
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4 p-2">
                                            <div class="form-group">
                                                <?php
                                                $document_path = $meat_renewal_view->slaughter_letter_doc;
                                        ...
                                        <div class="col-sm-4 col-md-4 p-2">
                                            <div class="form-group">
                                                <?php
                                                $document_path = $meat_renewal_view->treatment_authorized_doc;
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4 p-2">
                                            <div class="form-group">
                                                <?php
                                                $document_path = $meat_renewal_view->fitness_certificate_doc;
                                       ...
                                       <div class="col-sm-4 col-md-4 p-2">
                                            <div class="form-group">
                                                <?php
                                                $document_path = $meat_renewal_view->issued_doc;
    ...
    <div class="col-sm-4 col-md-4 p-2">
        <div class="form-group">
            <?php
            $document_path = $meat_renewal_view->Factory_reg_and_license_doc; // Ensure this points to the correct variable
            ...
            ?>
                    <!-- Show the image if it's an image file -->
                    <a href="{{url('/')}}/PMC_Cold_Storage/meat_file/Factory_reg_and_license_doc/{{ $meat_renewal_view->Factory_reg_and_license_doc }}" target="_blank">
                        <p class="mt-3 mb-0" id="image_div">
                            <img src="{{url('/')}}/PMC_Cold_Storage/meat_file/Factory_reg_and_license_doc/{{ $meat_renewal_view->Factory_reg_and_license_doc }}" alt="image" class="img-fluid rounded" width="200" height="100" style="max-height:150px;">
                        </p>
                    </a>
            <?php
                } else {
            ...
            <div class="modal-body">
                <form method="POST" action="{{ url('reject_coldStorage_renewal_by_hod', $meat_renewal_view->id ) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-md-3"></label>
                        <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                            <a href='{{ url("/hod_cold_storage_renewal_view/{$meat_renewal_view->id}/{$meat_renewal_view->re_hod_status}") }}' class="btn btn-danger btn-lg">Cancel</a>&nbsp;&nbsp;
                            <button type="submit" class="btn btn-success btn-lg">Submit</button>
                        </div>
                    </div>
                </form>
