...
// ----------------------********************* New Begining=====================
    ...
    Route::get('/cold_storage_invoice/{id}/{status}', [ColdStorageListController::class, 'coldRegistrationInvoice'])->name('cold_storage_invoice');

    Route::get('/approve_cold_registration/{id}', [ColdStorageListController::class, 'ApproveColdStorageRegistration'])->name('admin.approve_cold_registration');
    ...
    // ------ cold storage renewal admin panel list ------------------
     ...
     Route::get('/cold_storage_renewal_invoice/{id}/{status}', [ColdStorageRenewalListController::class, 'coldRenewalInvoice'])->name('cold_storage_renewal_invoice');

     Route::get('/approve_coldStorage_renewal/{id}', [ColdStorageRenewalListController::class, 'ApproveColdStoragerenewal'])->name('admin.approve_coldStorage_renewal');
...
// ----------------- Report -------------------------------
    ...
    Route::get('/cold_storage_lists/{status}', [HodColdStorageListController::class, 'ColdStorageRegistrationList'])->name('hod.cold_storage_lists');

    Route::get('/cold_storage_views/{id}/{status}', [HodColdStorageListController::class, 'ColdStorageView'])->name('hod.cold_storage_views');
 ...
 // ========= Cold Storage Renewal Hod Aprove,reject list hod pannel 
    ...
    Route::post('/reject_coldStorage_renewal_by_hod/{id}', [HodColdStorageRenewalListController::class, 'RejectColdStoragerenewal'])->name('hod.reject_coldStorage_renewal');
     ...
     Route::get('/final_approve_invoice/{id}/{status}', [HodColdStorageListController::class, 'coldRegistrationInvoice'])->name('final_approve_invoice');
     ...
     Route::get('/all_register_pet/view/{id}', [HodColdStorageListController::class, 'report_view'])->name('view.cold_Report_view');
    ...
    Route::get('/final_approve_renewa_invoice/{id}/{status}', [HodColdStorageRenewalListController::class, 'coldRenewalInvoice'])->name('final_approve_renewa_invoice');
...
// Route::post('/check-application-status', [ColdStorageRegistrationController::class, 'check_application_status'])->name('check-application-status');
    ...
    Route::match(['get','post'], '/check-application-status', [ColdStorageRegistrationController::class, 'check_application_status'])->name('check-application-status');
    
// ======================= User Dashboard for Cold Storage user/appli_form/View_coldstorage
    ...
    Route::get('/user/appli_form/invoice_coldstorage/{application_no}/{user_type}', [ColdStorageRegistrationController::class, 'coldRegistrationInvoice'])->name('user.appli_form.invoice_coldstorage');
...
Route::get('/user/appli_form/invoice_renewal/{application_no}/{user_type}', [ColdStorageRegistrationRenewalController::class, 'coldRenewalInvoice'])->name('user.appli_form.invoice_renewal');
